...
AT.GR.005.001
    ...
    ...              of free processors.
    Create UCC file list    fileList.txt    @{DEFAULT FILE LIST}
    Run UCC    java  -jar  @{UCC BASE}   -threads  4
...
AT.GR.005.003
    ...
    Run UCC  java  -jar  @{UCC BASE}                -i1  File List A.txt  -threads  4
    Response should not contain  Error: -threads is not a valid UCC command line argument.
...
AT.GR.006.001
    ...
    ...              increments.
    Create UCC file list    fileList.txt    @{DEFAULT FILE LIST}
    Run UCC    java  -jar  @{UCC BASE}  -ramlimit  1
...
AT.GR.006.002
    ...
    Run UCC    java  -jar  @{UCC BASE}  -dir  ${LARGE FILE DIR}  -ramlimit  1
...
AT.GR.006.003
    ...
    Copy File                @{DIFFSET1.fileAlist}[0]   FileA1.cpp
    Copy File                @{DIFFSET1.fileBlist}[0]   FileB2.cpp
    Run UCC   java  -jar  @{UCC BASE}               -d  -i1  File List A.txt  -i2  FileListB.txt  -ramlimit  1
    Response should not contain
    ...     Error: -ramlimit is not a valid UCC command line argument.
    Response should not contain
    ...     Available RAM is not enough for estimated needs.
...
AT.GR.022.002
	[Documentation]			Manually check if UCC throws an error for negative ramlimit
	Run UCC                 java  -jar  @{UCC BASE}  -ramlimit  "string"
...
AT.GR.024.002
	...
	Run UCC                 java  -jar  @{UCC BASE}  -dir  @{GENERAL}  empty.py
