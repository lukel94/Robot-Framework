...
AT.OT.004.002
    ...
    Create UCC File List     FileListB.txt      @{DIFFSET1.fileBlist}
    Create directory         Test
    Run UCC    @{UCC BASE}                  -d  -outdir  Test
    Response Status Check    0  0  0  0  0
...
AT.OT.005.001
    ...
    Create UCC File List     FileList.txt      @{COUNTSET1.filelist}
    Create directory         Test
    Run UCC    @{UCC BASE}                  -outdir  ${EXECDIR}${/}Test
    Response Status Check    0  0  0  0  0
    File should exist        Test${/}*_outfile.csv
    File should exist        Test${/}outfile_cplx.csv
    File should exist        Test${/}outfile_cyclomatic_cplx.csv
...
AT.OT.005.002
    ...
    Create UCC File List     FileListB.txt      @{DIFFSET1.fileBlist}
    Create directory         Test
    Run UCC    @{UCC BASE}                  -d  -outdir  ${EXECDIR}${/}Test
    Response Status Check    0  0  0  0  0
    File should exist        Test${/}Baseline-A-*_outfile.csv
    File should exist        Test${/}Baseline-A-outfile_cplx.csv
    File should exist        Test${/}Baseline-A-outfile_cyclomatic_cplx.csv
...
AT.OT.007.001
    ...
    Run UCC    @{UCC BASE}                  -outdir  Test.1
    Response Status Check    0  0  0  0  0
...
AT.OT.007.002
    ...
    Create UCC File List     FileListB.txt      @{DIFFSET1.fileBlist}
    Create directory         Test.1
    Run UCC    @{UCC BASE}                  -d  -outdir  Test.1
    Response Status Check    0  0  0  0  0
...
AT.OT.008.001
    ...
    Run UCC    @{UCC BASE}                  -outdir  Test_1
    Response Status Check    0  0  0  0  0
...
AT.OT.008.002
    ...
    Create UCC File List     FileListB.txt      @{DIFFSET1.fileBlist}
    Create directory         Test_1
    Run UCC    @{UCC BASE}                  -d  -outdir  Test_1
    Response Status Check    0  0  0  0  0
...
AT.CC.001.001	
	...
	Run UCC                 @{UCC BASE}	-dir	@{CC FOR XMIDAS SOURCE}	x_midas_testcase1.txt  
    File should exist 		outfile_cyclomatic_cplx.csv
...
AT.CC.002.001	
	...
	Run UCC                 @{UCC BASE}	-dir	@{CC FOR XMIDAS SOURCE}	x_midas_testcase2.txt  
    File should exist 		outfile_cyclomatic_cplx.csv

AT.CC.003.001	
	[Documentation] 		UCC should be able to calculate the number of control flows with loop, endloop statements in XMIDAS source
	Run UCC                 @{UCC BASE}	-dir	@{CC FOR XMIDAS SOURCE}	x_midas_testcase3.txt  
    File should exist 		outfile_cyclomatic_cplx.csv
...
AT.CC.004.001	
	...
	Run UCC                 @{UCC BASE}	-dir	@{CC FOR XMIDAS SOURCE}	x_midas_testcase4.txt  
    File should exist 		outfile_cyclomatic_cplx.csv
	
AT.CC.005.001	
	[Documentation] 		UCC should be able to calculate the number of control flows with if, else, endif statements in XMIDAS source
	Run UCC                 @{UCC BASE}	-dir	@{CC FOR XMIDAS SOURCE}	x_midas_testcase5.txt  
    File should exist 		outfile_cyclomatic_cplx.csv
...
AT.CC.006.001	
	...
	Run UCC                 @{UCC BASE}	-dir	@{CC_FOR_NEXTMIDAS_SOURCE}	nextmidas_TC_1.mm 
    File should exist 		outfile_cyclomatic_cplx.csv
...
AT.CC.010.001	
	...
	Run UCC                 @{UCC BASE}	-dir	@{CC_FOR_NEXTMIDAS_SOURCE}	nextmidas_TC_5.mm  
    File should exist 		outfile_cyclomatic_cplx.csv
...
AT.INT.003.001	
	...
	Run UCC                 @{UCC BASE}  -dir  @{DIRECTORY}  *.cpp
...
AT.INT.007.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d	-i1		filelistA.txt	
	Response should contain 	Building list of source files
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5
...
AT.INT.008.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d	-i1		filelistA.txt	-t	10	
	Response should contain 	Building list of source files
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5
...
AT.INT.009.001	
	...
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-t	10	
	Response should contain 	Building list of source files
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5
...
AT.INT.010.001	
	...
	Run UCC                 @{UCC BASE} 		-dir	  @{MAINTENANCE MATLAB ALL SOURCE}  *.m  
	File should exist 		outfile_summary.csv
	Time limit		5
	
AT.INT.011.001	
	[Documentation]			UCC should run with help option
	Run UCC                 @{UCC BASE} 		-help  
...
AT.INT.012.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d  -i1		filelistA.txt	-i2		filelistB.txt	-visualdiff	
...
AT.INT.013.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-tdup 	12		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5
...
AT.INT.014.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-tdup  -10		
	Time limit		5
...
AT.INT.015.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-tdup  "string"		
	Time limit		5
...
AT.INT.016.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-tdup  112		
	Time limit		5
...
AT.INT.017.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE A FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nodup		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv	
	Time limit		5
...
AT.INT.018.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nolinks		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5
...
AT.INT.021.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nocomplex		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv		
	Time limit		5
...
AT.INT.022.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d  -i1		filelistA.txt	-i2		filelistB.txt	-visualdiff	  -threads  4
	File should exist		diff_dump.txt  highlighted_diff.html
	Time limit		5
...
AT.INT.023.001	
	[Documentation]			Check if UCC runs with visualdiff option and threads
    Create baseline A file list     @{BASELINE A FILE LIST}	
	Run UCC                 @{UCC BASE}  -i1		filelistA.txt	-visualdiff	  -threads  4
	File should exist		outfile_summary.csv
	Time limit		5
...
AT.INT.024.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-tdup 	12  -threads  4	
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5	
...
AT.INT.025.001	
	[Documentation]			Check if UCC runs with tdup option and threads
    Create baseline A file list     @{BASELINE A FILE LIST}
	Run UCC                 @{UCC BASE}   -i1		filelistA.txt	-tdup 	12  -threads  4	
	File should exist		outfile_summary.csv
	Time limit		5
...
AT.INT.026.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d	-t	30	 -threads  4
	Response should contain 	Building list of source files
	File should exist		MatchedPairs.csv	outfile_diff_results.csv	
	Time limit		5
...
AT.INT.027.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nocomplex  -threads  4		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv		
	Time limit		5
...
AT.INT.028.001	
	[Documentation]			Check if UCC runs with nocomplex and threads option
    Create baseline A file list     @{BASELINE A FILE LIST}
	Run UCC                 @{UCC BASE}  -i1		filelistA.txt	-nocomplex  -threads  4		
	File should exist		outfile_summary.csv		
	Time limit		5
...
AT.INT.029.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}	
	Run UCC                 @{UCC BASE}  -i1		filelistA.txt   -trunc  100  -threads  4		
	File should exist		outfile_summary.csv		
	Time limit		5	
...
AT.INT.030.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}	  
    Create baseline B file list     @{BASELINE B FILE LIST}	  
	Run UCC                 @{UCC BASE}  -d  -i1		filelistA.txt  -i2  filelistB.txt   -trunc  100  -threads  4		
	File should exist		outfile_diff_results.csv	
	Time limit		5	
...
AT.INT.032.001	
	...
	Create default file list     @{DEFAULT FILE LIST}	
	Run UCC                 @{UCC BASE}  -ascii  -threads  4		
	File should exist		outfile_summary.txt		
	Time limit		5
...
AT.INT.033.001	
	...
	Create default file list     @{DEFAULT FILE LIST}
	Run UCC                 @{UCC BASE}  -legacy  -threads  4
	File should exist		outfile_summary.txt
	Time limit		5
...
AT.INT.034.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE B FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nolinks  -threads  4		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv
	Time limit		5	
...
AT.INT.035.001	
	[Documentation]			Check if UCC runs with nolinks and threads option
    Create baseline A file list     @{BASELINE A FILE LIST}
	Run UCC                 @{UCC BASE}  -i1		filelistA.txt	-nolinks  -threads  4		
	File should exist		outfile_summary.csv
	Time limit		5	
...
AT.INT.036.001	
    ...
    Create baseline A file list     @{BASELINE A FILE LIST}
    Create baseline B file list     @{BASELINE A FILE LIST}	
	Run UCC                 @{UCC BASE}  -d 	-i1		filelistA.txt	-i2		filelistB.txt	-nodup  -threads  4		
	File should exist		MatchedPairs.csv	outfile_diff_results.csv	
	Time limit		5	
...
AT.MAIN.004.001	
	...
	Run UCC                 @{UCC BASE} 		-dir	  @{MAINTENANCE PYTHON SINGLE SOURCE}  a.py  
	File should exist 		outfile_summary.csv	
	Time limit		0.35

AT.MAIN.005.001	
	[Documentation]			UCC should not crash when processing cyclomatic complexity for python files.
	Run UCC                 @{UCC BASE} 		-dir	  @{MAINTENANCE PYTHON CYCLOMATIC SOURCE}  *.py  
	File should exist 		outfile_summary.csv	
	Time limit		0.35

AT.OE.001.001	
	[Documentation] 		UCC should generate output summary file for valid header
	Run UCC                 @{UCC BASE}  -dir  @{MAINTENANCE PYTHON SINGLE SOURCE}  -header  @{HEADER H1}
    File should exist 		outfile_summary.csv
...
AT.OE.003.001
	...
	Run UCC                 @{UCC BASE}  -dir  @{MAINTENANCE PYTHON SINGLE SOURCE}  -header  @{HEADER INVALID}
...
AT.OE.014.001	
	...
	Run UCC                 @{UCC BASE}  -d  -dir  @{OUTPUT ENHANCEMENTS SOURCE}  @{MAINTENANCE CSHARP ALL SOURCE}  -visualdiff
	File should exist		diff_dump.txt  highlighted_diff.html
	
AT.OE.015.001	
	[Documentation] 		Check if Visual differencing switch is working with header
	Run UCC                 @{UCC BASE}  -d  -dir  @{OUTPUT ENHANCEMENTS SOURCE}  @{MAINTENANCE CSHARP ALL SOURCE}  -visualdiff  -header  @{HEADER H1}
	File should exist		diff_dump.txt  highlighted_diff.html
	
AT.OE.016.001	
	[Documentation] 		Check if Visual differencing switch is working with no header
	Run UCC                 @{UCC BASE}  -d  -dir  @{OUTPUT ENHANCEMENTS SOURCE}  @{MAINTENANCE CSHARP ALL SOURCE}  -visualdiff  -noheader
	File should exist		diff_dump.txt  highlighted_diff.html
	
AT.OE.017.001	
	[Documentation] 		Check if Visual differencing switch is working for JAVA files
	Run UCC                 @{UCC BASE}  -d  -dir  @{OUTPUT ENHANCEMENTS JAVA1}  @{OUTPUT ENHANCEMENTS JAVA2}  -visualdiff
	File should exist		diff_dump.txt  highlighted_diff.html	
