...
module handlers
  ...
  & gtk_notebook_set_group_name, FALSE, TRUE, GTK_WINDOW_TOPLEVEL, GTK_POS_TOP
  use widgets
...
! Rotate the position of the tabs
  function rotate_book (widget, gdata ) result(ret)  bind(c)
    ...
    integer(c_int)     :: ret
    type(c_ptr), value :: widget, gdata
    call gtk_notebook_set_tab_pos (notebook_1, &
         & gtk_notebook_get_tab_pos(notebook_1)+1_c_int)
    ret = FALSE
...
program notebook_example
  ...
  table = gtk_table_new (3_c_int, 6_c_int, FALSE)
  ...
  call gtk_table_attach_defaults (table, notebook_1, 0_c_int, 6_c_int, &
       & 0_c_int, 1_c_int)
...
!!$  print *, "=> This will work with GTK+ 3"
  ...
  call gtk_table_attach_defaults (table, button, 0_c_int, 1_c_int, &
       & 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, button, 1_c_int, 2_c_int, &
       & 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, button, 2_c_int, 3_c_int, 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, button, 3_c_int, 4_c_int, 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, button, 4_c_int, 5_c_int, 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, button, 5_c_int, 6_c_int, 1_c_int, 2_c_int)
  ...
  call gtk_table_attach_defaults (table, notebook_2, 0_c_int, 6_c_int, 2_c_int, 3_c_int)
