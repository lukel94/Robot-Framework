...
Public Class crpCommission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NETRuikeZhong.crpCommission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpCommission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpCommission = New crpCommission
        rpt.Site = Me.Site
        Return rpt
    End Function
